...
# Libraries
pacman::p_load(tidyverse, countrycode, sf, state, htmltools, htmlwidgets, urltools, janitor, DT, RColorBrewer, plotly, readxl, writexl, UpSetR)
...
pred_list <- 
  read_csv("/Users/saurabh/My Drive/GitHub/beall-live/data/df_weekly_publishers.csv") %>% 
  bind_rows(read_csv("/Users/saurabh/My Drive/GitHub/beall-live/data/df_weekly_standalone.csv")) %>% 
  clean_names() %>% 
  remove_empty()
