...
```{r}
read_csv(here::here("data/jonas/beacon-report-2021.csv"))
```
...
df %>%
  ...
  write_csv(here::here("data/beacon-latest/beacon-clean.csv"))

df %>% 
  filter(total_record_count > 0, str_detect(oai_url, "juntadean"))
```
