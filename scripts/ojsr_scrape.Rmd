...
```{r}
x <- oai::list_identifiers("https://ojs.stanford.edu/ojs/index.php/index/oai")
x %>% arrange(datestamp)
```

```{r}
y <- oai::list_records("https://ojs.stanford.edu/ojs/index.php/index/oai")
