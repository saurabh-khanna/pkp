...
df2019 <- df %>% filter(total_record_count > 0) %>% select(record_count_2019, total_record_count, oai_url, version, repository_name, issn, country, set_spec, earliest_datestamp)
```
...
df2020 <- df %>% filter(total_record_count > 0) %>% select(record_count_2020, total_record_count, oai_url, version, repository_name, issn, country, set_spec, earliest_datestamp)
```
...
df2021 <- df %>% filter(total_record_count > 0) %>% select(record_count_2021, total_record_count, oai_url, version, repository_name, issn, country, set_spec, earliest_datestamp)
```
